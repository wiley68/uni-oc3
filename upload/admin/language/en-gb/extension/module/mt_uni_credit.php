...
$_['text_event_health_repair_failed'] = 'Presentation events could not be registered or repaired. Check DB write permissions for the event table and OpenCart error log (mt_uni_credit: ensureCatalogEvents).';
