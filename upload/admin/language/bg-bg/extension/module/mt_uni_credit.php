...
$_['text_success'] = 'Успех: Промените в настройките на UniCredit модула бяха запазени!';
$_['text_edit'] = 'Редакция на UniCredit модул';
...
$_['error_permission'] = 'Внимание: Нямате права да променяте настройките на UniCredit модула!';
