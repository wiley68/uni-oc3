...
$_['text_event_health'] = 'Здраве на presentation events';
$_['text_event_health_ok'] = 'Presentation events са здрави. Всички Thank You / native mail presentation events са регистрирани и активни.';
$_['text_event_health_repair_failed'] = 'Опит за поправка на presentation events при отваряне на тази страница, но събитията все още липсват или са нездрави. Проверете правата за запис в event таблицата и OpenCart error log (mt_uni_credit: ensureCatalogEvents).';
$_['column_event_code'] = 'Код';
$_['column_event_trigger'] = 'Очакван trigger';
$_['column_event_registered'] = 'Регистриран';
$_['column_event_enabled'] = 'Активен';
$_['column_event_duplicates'] = 'Дубликати';
$_['column_event_healthy'] = 'Здрав';
...
$_['error_secret_encrypt_failed'] = 'Секретът не може да бъде запазен сигурно. Предишният секрет е запазен.';
